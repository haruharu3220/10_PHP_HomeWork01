...
<body>
    ...
    <div class="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10 m-auto mt-10">
        ...
        <div class="mt-8">
            ...
            <div class=" flex items-center justify-center mt-6">
                <a href="new_account.php" class="inline-flex items-center text-xs font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white">
                    <div class="new-account cursor-pointer ml-2">
                        新規登録
                    </div>
                </a>
            </div>
