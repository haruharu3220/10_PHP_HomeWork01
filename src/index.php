            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="block">
                    <div class="flex items-center ml-4 md:ml-6">
                        <a href="https://github.com/Charlie85270/tail-kit" class="p-1 text-gray-400 rounded-full focus:outline-none hover:text-gray-200 focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                            <span class="sr-only">
                                View github
                            </span>
...
<!-- Body開始 -->
    <div class="bg-red-200 w-full"> aaaa
